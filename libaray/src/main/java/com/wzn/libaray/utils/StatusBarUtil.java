...
/**
 * GitHub: https://github.com/wznshuai/StatusBarUtil
 */
public class StatusBarUtil {
    ...
    public static void setColor(Activity activity, int color, int statusBarAlpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (null == activity.getActionBar()
                    && (activity instanceof AppCompatActivity && ((AppCompatActivity) activity).getActionBar() == null)) {
    ...
    public static void resetSatusBar(Activity activity) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            activity.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
            if (null == activity.getActionBar()
                    && (activity instanceof AppCompatActivity && activity.getActionBar() == null)) {
                getContentView(activity).setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_STABLE
                        | View.SYSTEM_UI_FLAG_LOW_PROFILE);
            }
            ViewCompat.requestApplyInsets(getContentView(activity));
